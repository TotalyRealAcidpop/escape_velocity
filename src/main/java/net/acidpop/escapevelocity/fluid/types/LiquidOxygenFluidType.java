...
public class LiquidOxygenFluidType extends FluidType {
	public LiquidOxygenFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("escape_velocity:block/liquid_oxygen_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("escape_velocity:block/liquid_oxygen_flow");
			...
			public Vector3f modifyFogColor(Camera camera, float partialTick, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector3f fluidFogColor) {
				return new Vector3f(0.6666666667f, 0.8392156863f, 0.8784313725f);
			}
