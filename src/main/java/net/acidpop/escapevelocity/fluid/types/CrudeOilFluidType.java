...
public class CrudeOilFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("escape_velocity:block/crude_oil_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("escape_velocity:block/crude_oil_flow");
			...
			public Vector3f modifyFogColor(Camera camera, float partialTick, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector3f fluidFogColor) {
				return new Vector3f(0.0666666667f, 0.062745098f, 0.0549019608f);
			}
