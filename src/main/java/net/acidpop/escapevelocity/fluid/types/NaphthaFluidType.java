...
public class NaphthaFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("escape_velocity:block/naphtha_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("escape_velocity:block/naphtha_flow");
			...
			public Vector3f modifyFogColor(Camera camera, float partialTick, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector3f fluidFogColor) {
				return new Vector3f(0.7254901961f, 0.8078431373f, 0.5882352941f);
			}
