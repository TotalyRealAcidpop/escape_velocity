...
public class ElectrolyzerTopUIScreen extends AbstractContainerScreen<ElectrolyzerTopUIMenu> {
	private final static HashMap<String, Object> guistate = ElectrolyzerTopUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElectrolyzerTopUIScreen(ElectrolyzerTopUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("escape_velocity:textures/screens/electrolyzer_top_ui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.escape_velocity.electrolyzer_top_ui.label_water_tank"), 66, 5, -12829636, false);
	}
